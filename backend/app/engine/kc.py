...
CROP_PARAMS = {
    # kc_mid for corn/soy/alfalfa: FAO-56 Table 12 via D-014. Corn's former
    # 1.15 was sweet corn's Kc_mid; field maize is 1.20.
    "corn":      (50.0, 36.0, 0.50, 0.30, 1.20, 0.60, 2700),  # kc_end: D-010, kc_mid: D-014
    "soy":       (50.0, 24.0, 0.50, 0.40, 1.15, 0.50, 2500),  # kc_end: D-013, kc_mid: D-014
    "alfalfa":   (41.0, 30.0, 0.50, 0.40, 0.95, 0.90, 1800),  # kc_end: D-013, kc_mid: D-014
    "cover":     (40.0, 10.0, 0.45, 0.30, 0.60, 0.55, 1200),
    "potatoes":  (45.0, 24.0, 0.35, 0.50, 1.15, 0.75, 1600),  # root/mad/kc_ini: D-013
    "sunflower": (46.0, 50.0, 0.50, 0.35, 1.10, 0.35, 2000),  # kc_end: D-013
    "cabbage":   (45.0, 18.0, 0.45, 0.70, 1.05, 0.95, 2000),
    "onions":    (40.0, 14.0, 0.30, 0.70, 1.05, 0.75, 1800),  # mad(p): D-013
    "sweet corn":(50.0, 24.0, 0.50, 0.30, 1.15, 1.05, 2200),  # kc_end: D-013
}
_CROP_PARAMS_DEFAULT = (50.0, 36.0, 0.5, 0.30, 1.20, 0.60, 2700)
